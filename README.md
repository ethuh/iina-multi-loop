...
<a href="https://github.com/ethuh/iina-multiple-segments-loop/releases">Releases</a> ·
<a href="https://t.me/IINAUsers">Telegram Group</a>
</p>

## Fork: Multi-segment Loop

This is a fork of upstream IINA with multi-segment looping support.
...
For this fork, download builds from this repo's [GitHub release page](https://github.com/ethuh/iina-multiple-segments-loop/releases). For upstream stable and beta releases, visit the upstream [GitHub release page](https://github.com/iina/iina/releases) or the [IINA official website](https://iina.io/).
...
* If you find a bug in this fork, or would like to suggest a new feature or enhancement, it'd be nice if you could [search your problem first](https://github.com/ethuh/iina-multiple-segments-loop/issues); while we don't mind duplicates, keeping issues unique helps us save time and consolidates effort. If you can't find your issue, feel free to [file a new one](https://github.com/ethuh/iina-multiple-segments-loop/issues/new/choose).
